...
<div class="card shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center py-3" style="background:linear-gradient(135deg,#003366,#0056b3);border-radius:.5rem .5rem 0 0;"><h5 class="mb-0 text-white fw-bold"><i class="fas fa-plus me-2"></i>Tambah Agenda</h5></div>
    <div class="card-body">
        @if($errors->any())
        ...
        @endif
        <form enctype="multipart/form-data" action="{{ url('admin.agenda.store') }}" method="POST">
            {!! csrf_field() !!}
        ...
        <div class="mb-3">
            ...
            <select name="kategori" class="form-select" required>
                ...
                <option value="Seni & Budaya" {{ old('kategori') == 'Seni & Budaya' ? 'selected' : '' }}>Seni & Budaya</option>
