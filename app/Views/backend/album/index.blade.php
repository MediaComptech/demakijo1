...
<div class="card shadow-sm border-0">
    <div class="card-header d-flex justify-content-between align-items-center py-3"
         style="background:linear-gradient(135deg,#5b21b6,#8b5cf6);border-radius:.5rem .5rem 0 0;">
        <h5 class="mb-0 text-white fw-bold"><i class="fas fa-images me-2"></i>Data Album Galeri</h5>
        <a href="{{ url('/admin/album/create') }}" class="btn btn-warning btn-sm fw-semibold">
