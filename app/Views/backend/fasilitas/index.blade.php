...
<div class="card shadow-sm border-0">
    <div class="card-header d-flex justify-content-between align-items-center py-3"
         style="background:linear-gradient(135deg,#1c1917,#57534e);border-radius:.5rem .5rem 0 0;">
        <h5 class="mb-0 text-white fw-bold"><i class="fas fa-building me-2"></i>Data Fasilitas</h5>
        <a href="{{ url('/admin/fasilitas/create') }}" class="btn btn-warning btn-sm fw-semibold">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <form action="{{ url('admin.fasilitas.destroy', $item->id) }}" method="POST"
                                  class="d-inline form-delete-confirm" data-label="fasilitas '{{ addslashes($item->nama ?? '') }}'">
