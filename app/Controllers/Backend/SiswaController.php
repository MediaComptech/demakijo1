...
class SiswaController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect("admin.siswa.index")->with("success", "Data berhasil ditambahkan");
    }
    ...
    public function update(Request $request, $id) {
        ...
        $model->update($input);
        Cache::forget("siswa_all");
        return redirect("admin.siswa.index")->with("success", "Data berhasil diubah");
    }
    public function destroy($id) {
        ...
        $model->delete();
        Cache::forget("siswa_all");
        return redirect("admin.siswa.index")->with("success", "Data berhasil dihapus");
    }
}
